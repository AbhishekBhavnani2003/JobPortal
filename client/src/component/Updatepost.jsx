...
export default function Example() {
  ...
  const updatePost = async (event) => {
    ...
    const postWithUsername = {
      ...
      createdby: createdby,
      audition: {
        venue: post.audition.venue,
        date: post.audition.date,
        time: post.audition.time,
      },
      agegroup: {
        from: post.agegroup.from,
        to: post.agegroup.to,
      },
    };
    ...
    <>
      <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center">
          <h4 className="text-xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            Hire a best fit for your requirement with JobPilot
          </h4>
        ...
        >
          <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
            ...
            >
              ...
              <label
                htmlFor="from"
                className="block text-sm font-semibold leading-6 text-blue-900"
            ...
            <div>
              ...
              <div className="mt-2.5">
                <input
                  ...
                  id="audition.date"
                  onChange={handleform}
                  value={formatDate(post.audition.date)}
                  rows={3}
                  className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                />
              </div>
                ...
                <LocalizationProvider dateAdapter={AdapterDayjs}>
                  <DemoContainer components={["TimePicker"]}>
                    <TimePicker
                      label="Audition Time"
                      value={
                        post.audition.time ? dayjs(post.audition.time) : null
                      }
