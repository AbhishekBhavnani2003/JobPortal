        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="max-w-2xl mx-auto mt-4 text-base text-gray-400 leading-relaxed md:text-2xl">
              Simplifying your casting process from start to finish
            </p>
          </div>
            ...
            <div className="relative grid grid-cols-1 text-center gap-y-12 md:grid-cols-3 gap-x-12">
              <div>
                ...
                <p className="mt-4 text-base text-gray-400 md:text-lg">
                  Sign up and create your casting profile.
                </p>
              </div>
              <div>
                <div className="flex items-center justify-center w-16 h-16 mx-auto bg-white border-2 border-gray-200 rounded-full shadow">
                ...
                <h3 className="mt-6 text-xl text-white font-semibold leading-tight md:mt-10">
                  Submit Casting Details
                </h3>
                <p className="mt-4 text-base text-gray-400 md:text-lg">
                  Fill in the details for the casting call.
                </p>
              </div>
              <div>
                <div className="flex items-center justify-center w-16 h-16 mx-auto bg-white border-2 border-gray-200 rounded-full shadow">
